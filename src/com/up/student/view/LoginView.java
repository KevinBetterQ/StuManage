...
public class LoginView extends JFrame {
	...
	private void check() {
		...
		if (adminDAO.queryForLogin(username.getText(), String.valueOf(password.getPassword()))==1) {
			dispose();
			new MainView();
		} else if(adminDAO.queryForLogin(username.getText(), String.valueOf(password.getPassword()))==2) {
			dispose();
			new StuMainView();
		}else {
			username.setText("");
